...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizeKristaTechAmount") || reset)
        SoftSetArg("-anonymizekristatechamount", settings.value("nAnonymizeKristaTechAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in kristatech.cpp during shotdown to also remove the window positions
