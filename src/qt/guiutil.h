...
/** Utility functions used by the KristaTech Qt UI.
 */
namespace GUIUtil
{
...
// Render KRISTA addresses in monospace font
...
// Parse "kristatech:" URI into recipient object, return true on successful parsing
