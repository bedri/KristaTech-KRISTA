...
#include "qt/kristatech/forms/ui_smartcontractwidget.h"
...
SmartContractWidget::SmartContractWidget(KRISTATECHGUI* parent) :
    PWidget(parent),
...
#include "qt/kristatech/visualdesignerdialog.h"
