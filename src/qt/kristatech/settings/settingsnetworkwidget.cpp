...
#include "qt/kristatech/settings/settingsnetworkwidget.h"
#include "qt/kristatech/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/kristatech/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(KRISTATECHGUI* _window, QWidget *parent) :
