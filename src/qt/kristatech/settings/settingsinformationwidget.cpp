...
#include "qt/kristatech/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(KRISTATECHGUI* _window,QWidget *parent) :
