...
#include "qt/kristatech/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(KRISTATECHGUI* _window, QWidget *parent) :
