...
#include "qt/kristatech/sendcustomfeedialog.h"
#include "qt/kristatech/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(KRISTATECHGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &KRISTATECHGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
