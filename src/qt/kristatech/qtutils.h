...
void closeDialog(QDialog* widget, KRISTATECHGUI* gui);
void openDialogFullScreen(QWidget* parent, QWidget* dialog);
bool openDialogWithOpaqueBackgroundY(QDialog* widget, KRISTATECHGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, KRISTATECHGUI* gui, double posX = 3);
bool openDialogWithOpaqueBackgroundFullScreen(QDialog* widget, KRISTATECHGUI* gui);
...
QString getCustomItem(QWidget* parent, const QString& title, const QString& label, const QStringList& items, int current = 0, bool editable = false, bool* ok = nullptr);
