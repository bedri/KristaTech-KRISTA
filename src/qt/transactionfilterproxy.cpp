...
{
    return ( (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint || type == TransactionRecord::MNReward || type == TransactionRecord::LlmqReward || type == TransactionRecord::AdamReward)
...
bool TransactionFilterProxy::isMasternodeRewardTx(int type) const {
    return (type == TransactionRecord::MNReward || type == TransactionRecord::LlmqReward || type == TransactionRecord::AdamReward);
}
