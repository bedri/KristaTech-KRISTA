...
bool PaymentRequestPlus::getMerchant(X509_STORE* certStore, QString& merchant, const QDateTime& currentTime) const
{
    merchant.clear();
    ...
    try {
        ...
        X509_STORE_CTX_set_time(store_ctx, 0, currentTime.toTime_t());
