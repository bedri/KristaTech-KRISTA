...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            KRISTATECHGUI* window = static_cast<KRISTATECHGUI*>(parentWidget());
...
{
    KRISTATECHGUI* gui = static_cast<KRISTATECHGUI*>(parentWidget());
...
{
    hide();
    static_cast<KRISTATECHGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("KristaTech will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your KRISTAs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
