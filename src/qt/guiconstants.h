...
/* KristaTech GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "KristaTech"
#define QAPP_ORG_DOMAIN "kristatech.org"
#define QAPP_APP_NAME_DEFAULT "KristaTech-Qt"
#define QAPP_APP_NAME_TESTNET "KristaTech-Qt-testnet"
