...
extern UniValue setblsprivkey(const JSONRPCRequest& request);
...
extern UniValue compilemescaltotaproot(const JSONRPCRequest& request);
...
extern UniValue createblsprivkey(const JSONRPCRequest& request);
