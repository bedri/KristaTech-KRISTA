...
public:
    CTestNetParams()
    {
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight                     = 200;
        consensus.vUpgrades[Consensus::UPGRADE_TIME_PROTOCOL_V2].nActivationHeight          = 450;
        consensus.vUpgrades[Consensus::UPGRADE_P2PKH_BLOCK_SIGNATURES].nActivationHeight    = 450;
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MIN_DEPTH_V2].nActivationHeight        = 5001;
        consensus.vUpgrades[Consensus::UPGRADE_MASTERNODE_RANK_V2].nActivationHeight        = 200;
        consensus.vUpgrades[Consensus::UPGRADE_ADAM].nActivationHeight                      = 200;
