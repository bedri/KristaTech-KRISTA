...
#define __PORT_MAINNET__ 27999
#define __PORT_TESTNET__ 27989
#define __PORT_REGTEST__ 27939
 ...
 * KristaTech system. There are three: the main network on which people trade goods
