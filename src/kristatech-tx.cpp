...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KristaTech kristatech-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kristatech-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kristatech transaction") + "\n" +
                               "  kristatech-tx [options] -create [commands]   " + _("Create hex-encoded kristatech transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kristatech transaction
