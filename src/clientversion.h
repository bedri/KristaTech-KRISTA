...
#error Client version information missing: version is not defined by kristatech-config.h or in any other way
#endif
...
/**
 * kristatechd-res.rc includes this file, but it cannot cope with real c++ code.
