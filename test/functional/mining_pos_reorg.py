...
class ReorgStakeTest(KristaTechTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected KRISTA supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check KRISTA supply at the beginning
        # ------------------------------------------
        # KRISTA supply: block rewards minus burned fees for minting
        ...
        # Verify that KRISTA supplies were properly updated after the spends and reorgs
        self.log.info("Check KRISTA supply...")
