...
* **Proof of BLS (PoBLS) Consensus**: A lightweight cryptographic lottery model with temporary BLS keys for fair and secure block production, integrated with ADAM and Model D reward splits. See [PoBLS Consensus Guide](doc/PoBLS_Consensus.md).
...
| 100,001 - 1,051,200 | Model D Hybrid | 20,000 KRISTA | 14.5 KRISTA | 60% (50% / 10%) | 40% (30% / 10%) | 8.7 KRISTA | 5.8 KRISTA + fees |
| Year 2 | Model D Hybrid | 20,000 KRISTA | 11.6 KRISTA | 60% (50% / 10%) | 40% (30% / 10%) | 6.96 KRISTA | 4.64 KRISTA + fees |
| Year 3 | Model D Hybrid | 20,000 KRISTA | 9.28 KRISTA | 60% (50% / 10%) | 40% (30% / 10%) | 5.568 KRISTA | 3.712 KRISTA + fees |
| Year 4 - 10 | Model D Hybrid | 20,000 KRISTA | Decays 20% / yr | 60% (50% / 10%) | 40% (30% / 10%) | 60% of reward | 40% of reward + fees |
...
> - **Block Producer / Winner (%30)**: Earned by the validator/staker who wins the PoBLS lottery to produce the block.
> - **Validator Participants (%10)**: Shared equally among the other 12 candidates in the ADAM validator set.
