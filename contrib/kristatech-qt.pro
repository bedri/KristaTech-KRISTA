...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/kristatech-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/kristatech-cli.cpp \
           src/kristatech-tx.cpp \
           src/kristatech.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/kristatech.qrc src/qt/kristatech_locale.qrc

TRANSLATIONS += src/qt/locale/kristatech_bg.ts \
                src/qt/locale/kristatech_de.ts \
                src/qt/locale/kristatech_en.ts \
                src/qt/locale/kristatech_es.ts \
                src/qt/locale/kristatech_fi.ts \
                src/qt/locale/kristatech_fr.ts \
                src/qt/locale/kristatech_it.ts \
                src/qt/locale/kristatech_ja.ts \
                src/qt/locale/kristatech_pl.ts \
                src/qt/locale/kristatech_pt.ts \
                src/qt/locale/kristatech_ru.ts \
                src/qt/locale/kristatech_sk.ts \
                src/qt/locale/kristatech_sv.ts \
                src/qt/locale/kristatech_vi.ts \
                src/qt/locale/kristatech_zh_CN.ts \
                src/qt/locale/kristatech_zh_TW.ts
