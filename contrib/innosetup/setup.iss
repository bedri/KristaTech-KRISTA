...
#define MyAppName "KristaTech Core"
#define MyAppPublisher "2022 DECENOMY Core Developers"
#define MyAppURL "https://kristatech.com"
#define MyAppExeName "kristatech-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/KRISTA/bootstrap.zip"
...
DefaultDirName={autopf}\KristaTech
...
OutputDir=.\output
OutputBaseFilename=KristaTechSetup
...
DefaultGroupName=KristaTech Core
...
[Files]
Source: ".\package\kristatech-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\KristaTech\KristaTech-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\KristaTech\KristaTech-Qt,strDataDir|{userappdata}\KristaTech\}');
  Result := True;
end;
