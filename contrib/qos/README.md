...
This means one can have an always-on kristatechd instance running, and another local kristatechd/kristatech-qt instance which connects to this node and receives blocks from it.
