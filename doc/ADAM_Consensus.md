...
* $\text{VRFProof}_{H-1}$ is the signature generated by the elected **Coordinator** of block $H-1$ on the previous seed $\text{Seed}_{H-2}$ using RFC 6979 deterministic ECDSA signatures.
