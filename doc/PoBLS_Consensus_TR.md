...
PoBLS entegrasyonu sonrasında blok ödülünün (örneğin Blok 100.001+ için %60 Masternode / %40 Miner-Staker dağılımının) kendi içindeki kırılımı için üç farklı ekonomik model kurgulanabilir:
