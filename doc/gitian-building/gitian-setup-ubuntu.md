...
The build script we'll be using is contained in the KristaTech github repository ([contrib/gitian-build.py](https://github.com/bedri/KristaTech-KRISTA/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the KristaTech repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/KristaTech-Project/KristaTech/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, kristatech-detached-sigs, and kristatech GitHub repos.
