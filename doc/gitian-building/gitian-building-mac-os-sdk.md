...
The script [extract-osx-sdk.sh](https://github.com/bedri/KristaTech-KRISTA/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
kristatech/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/bedri/KristaTech-KRISTA/blob/master/doc/README_osx.md) for troubleshooting tips.
