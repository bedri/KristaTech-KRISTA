...
2. **Extended Reward Lifecycle (1.9% Decay):** The quarterly decay rate has been reduced from 5% to **1.9%**. As a result, block rewards decline much slower, and **block rewards remain active for 50+ years**.
