...
3. **Masternode Collateral:** Updated to a flat **4,200 KRISTA** in proportion to the supply.
...
| **Masternode Collateral** | 1,000 KRISTA | **4,200 KRISTA** |
...
* **Year 0 (First 10,000 Blocks / Bootstrap):**
  ...
  - *Masternode Impact:* At block 2,000 (LLMQ activation), there are 200,000 KRISTA in circulation. Under the 4,200 KRISTA collateral requirement, this can support up to **47 active masternodes** (more than double the 20+ requirement for active quorums). Quorum deadlocks are completely prevented.
...
3. **Quorum Stability:** The flat 4,200 KRISTA collateral requirement, paired with the high bootstrap reward (100 KRISTA), provides 47+ masternode capacity at block 2,000, stabilizing LLMQ structures immediately.
