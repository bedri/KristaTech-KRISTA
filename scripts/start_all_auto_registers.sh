...
nohup python3 krista_auto_register.py pow 27979 > krista_auto_register_27979.err 2>&1 &
...
do
    port=$((28000 + 2 * i))
    nohup python3 krista_auto_register.py pow $port > krista_auto_register_$port.err 2>&1 &
