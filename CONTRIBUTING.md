Contributing to KristaTech Core
============================

The KristaTech Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/kristatech-project/kristatech/blob/master/doc/translation_process.md)
...
The following applies to code changes to the KristaTech Core project, and is not to be
confused with overall KristaTech Network Protocol consensus changes.

Whether a pull request is merged into KristaTech Core rests with the project merge
...
Patches that change KristaTech consensus rules are considerably more involved than
...
Where a patchset proposes to change the KristaTech consensus, it must have been
...
The project leader is the release manager for each KristaTech Core release.
