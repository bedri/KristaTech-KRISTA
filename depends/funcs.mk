...
$(1)_autoconf=./configure --host=$($($(1)_type)_host) --disable-dependency-tracking --prefix=$($($(1)_type)_prefix) --libdir=$($($(1)_type)_prefix)/lib $$($(1)_config_opts) CC="$$($(1)_cc)" CXX="$$($(1)_cxx)"
